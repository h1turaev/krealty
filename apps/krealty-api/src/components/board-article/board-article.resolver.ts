...
export class BoardArticleResolver {
  ...
  //============================== ADMIN: GET ALL BOARD ARTICLES API ==============================//
  ...
  //============================== ADMIN: UPDATE BOARD ARTICLE API ==============================//
  @Roles(MemberType.ADMIN)
  @Mutation(() => BoardArticle)
